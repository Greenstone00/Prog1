/*
    g++ drill16.cpp Graph.cpp Window.cpp GUI.cpp Simple_window.cpp -o ch16 `fltk-config --ldflags --use-images`
*/
...
private:
    Open_polyline lines;
    //buttons and writeable thingies
    Button next_button; // add (next_x,next_y) to lines
    Button quit_button; // quits this time for real
    In_box next_x;
    In_box next_y;
    Out_box xy_out;
    Menu color_menu;
    ...
    static void cb_red(Address, Address); // cb for red button
    static void cb_blue(Address, Address); // cb 4 blue button
    static void cb_black(Address, Address); // cb 4 black button
    static void cb_green(Address, Address); // cb 4 green button
